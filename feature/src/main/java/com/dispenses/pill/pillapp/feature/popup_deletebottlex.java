...
public class popup_deletebottlex extends AppCompatDialogFragment {
                ...
                .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (dbHandler.deleteSchedule(name)) {
                            new AsyncDelX().execute(name,table);
    ...
    private class AsyncDelX extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            pdLoading.dismiss();
            Toast.makeText(globalContext, result, Toast.LENGTH_LONG).show();
        }
