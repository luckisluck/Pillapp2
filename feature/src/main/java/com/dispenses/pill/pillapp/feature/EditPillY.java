...
public class EditPillY extends AppCompatDialogFragment {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .setPositiveButton("SAVE", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        setDefaults(keyY,name,getActivity());
                        new Asyncaddpilly().execute(Tpill);
    ...
    private class Asyncaddpilly extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        .appendQueryParameter("pillAmty", params[0]);
