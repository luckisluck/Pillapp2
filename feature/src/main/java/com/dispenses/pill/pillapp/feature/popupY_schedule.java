...
public class popupY_schedule extends AppCompatDialogFragment {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ADD", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        final String table ="dispenseauto_Y";
                        int k= Integer.parseInt(pillAmt);
                        try {
                            bottleyGetSet p = new bottleyGetSet(name,startTime,endTime,k);
    ...
    private class AsyncaddRecordYAutos extends AsyncTask<String, String, String> {
