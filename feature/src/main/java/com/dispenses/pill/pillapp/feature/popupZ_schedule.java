...
public class popupZ_schedule extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.popup_yschedule, null);
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ADD", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        try {
                            bottlezGetSet p = new bottlezGetSet(name,startTime,endTime,k);
                            dbHandler.bottlezAdd(p);
                        } catch (Exception e) {
                            Toast.makeText(context, "didnt add to DB", Toast.LENGTH_LONG).show();
                        }
                        new AsyncaddRecordZAutos().execute(name,startTime,endTime,pillAmt,table);
    ...
    private class AsyncaddRecordZAutos extends AsyncTask<String, String, String> {
